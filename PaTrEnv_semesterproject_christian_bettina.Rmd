...
# Die Kleinste Zeitperiode ist 5 Tage, was höchst wahrscheinlich nicht genügend Zeit ist für ein Wildschwein um sich daran zu gewöhnen. Dies wird höchstens am Ende noch utnersucht, sofern sich herausstellt, dass sie sich so schnell daran gewöhnen. 
...
```{r die Minimaldistanz zu den Wildschweinschrecks bestimmen, echo=T, results='hide', message=F, warning=F}
...
# spalten mit den koordinaten der WWS zu den Wildschweindaten hinzufügen und dafür Eucledian Distances berechnen?
